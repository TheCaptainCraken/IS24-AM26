...
public class NetworkHandler {
     ...
     */
    public void sendingPlacedRootCardAndWhenCompleteObjectiveCardsBroadcast(String nickname, boolean side, int cardId, boolean allWithRootCardPlaced) {
        for (NetworkPlug networkPlug : networkInterfacesAndConnections.values()) {
     ...
     */
    public void sendingHandsAndWhenSecretObjectiveCardsCompleteStartGameFlowBroadcast(String nickname, boolean allWithSecretObjectiveCardChosen) {
        for (NetworkPlug networkPlug : networkInterfacesAndConnections.values()) {
     ...
     */
    public void sendDrawnCardBroadcast(String nickname, int newCardId, Kingdom headDeck, boolean gold, int onTableOrDeck) {
        for (NetworkPlug networkPlug : networkInterfacesAndConnections.values()) {
