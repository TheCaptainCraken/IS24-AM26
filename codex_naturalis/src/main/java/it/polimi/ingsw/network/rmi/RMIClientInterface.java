...
/**
 * The RMIClientInterface interface defines the methods that are used for network communication in the game.
 * These methods are called by the ServerRMI class, which is the class that manages the network connections for the server.
 */
public interface RMIClientInterface extends Remote {
    ...
    /**
     * This method is used to send the common cards to the clients. They are the common cards on the table.
    ...
    /**
     * This method is used to show the hand of the player. We send the hand of the player to the client.
    ...
    /**
     * This method is used to show the hidden hand of the player. We send the hidden hand of the player to the client.
     * This is the hidden hand of the player. It is just a pair: kingdom and boolean. The boolean is true if the card is gold, false otherwise.
     * @param nickname The nickname of the player.
    ...
    /**
     * This method is used to send TurnInfo to the clients. It contains the current player and the game state.
     * @param currentPlayer
     * @param gameState The game state. It is a enum that can be  CHOOSING_ROOT_CARD, CHOOSING_OBJECTIVE_CARD, DRAWING_PHASE, PLACING_PHASE, END
     * @throws RemoteException
     */
    void refreshTurnInfo(String currentPlayer, GameState gameState) throws RemoteException;
    /**
     * This method is used to place a card on the board. It also sends the resources and the points of the player.
    ...
    /**
     * This method is used to communicate the new card on table and the new card on deck. It is a broadcast call.
     * @param newCardId The id of the new card.
     * @param headDeck The head deck.
     * @param gold A boolean indicating whether the card is gold. To know which deck to update.
    ...
    /**
     * This method is used to show the end game to the clients. It is a broadcast call.
    ...
    /**
     * This method sends the first player information. When this call arrives, the client knows who is the first player and can start the game.
