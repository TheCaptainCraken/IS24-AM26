...
/**
 * The RMIServerInterface interface defines the methods that are used for network communication in the game.
 * These methods are called by the RMIServer class, which is the class that manages the network connections for client.
 */
public interface RMIServerInterface extends Remote {
     ...
     * @param numberOfPlayers The number of players in the game. It must be between 2 and 4. Client interface will check this.
     * @throws RemoteException throws a RemoteException if there is a problem with the connection.
     * @throws ClosingLobbyException throws a ClosingLobbyException if the lobby is closing.
     * @throws SameNameException throws a SameNameException if two players have the same nickname.
     * @throws LobbyCompleteException throws a LobbyCompleteException if the lobby is already full or the game has already started.
     ...
     * @throws RemoteException throws a RemoteException if there is a problem with the connection.
     * @throws ColorAlreadyTakenException throws a ColorAlreadyTakenException if the color is already taken by another player.
     * @throws NoNameException throws a NoNameException if a player with the given nickname does not exist.
     */
     ...
     * @throws RemoteException throws a RemoteException if there is a problem with the connection.
     * @throws WrongGamePhaseException throws a WrongGamePhaseException if the player is trying to choose the starting card in the wrong game phase.
     * @throws NoTurnException throws a NoTurnException if the player is trying to choose the starting card when it is not his turn.
     * @throws NoNameException throws a NoNameException if a player with the given nickname does not exist.
     */
     ...
     * @throws RemoteException throws a RemoteException if there is a problem with the connection.
     * @throws WrongGamePhaseException throws a WrongGamePhaseException if the player is trying to choose the secret objective card in the wrong game phase.
     * @throws NoTurnException throws a NoTurnException if the player is trying to choose the secret objective card when it is not his turn.
     * @throws NoNameException throws a NoNameException if a player with the given nickname does not exist.
     */
     ...
     * @throws RemoteException throws a RemoteException if there is a problem with the connection.
     * @throws WrongGamePhaseException throws a WrongGamePhaseException if the player is trying to place a card in the wrong game phase.
     * @throws NoTurnException throws a NoTurnException if the player is trying to place a card when it is not his turn.
     * @throws NotEnoughResourcesException throws a NotEnoughResourcesException if the player does not have enough resources to place the card.
     * @throws NoNameException throws a NoNameException if a player with the given nickname does not exist.
     * @throws CardPositionException throws a CardPositionException if the player is trying to place a card in an invalid position.
     */
     ...
     * @param onTableOrDeck An integer indicating whether the card is on the table or deck. It is -1, to pick from deck, 0 or 1 to pick from table.
     * @return The id of the card drawn by the player.
     * @throws RemoteException throws a RemoteException if there is a problem with the connection.
     * @throws WrongGamePhaseException throws a WrongGamePhaseException if the player is trying to draw a card in the wrong game phase.
     * @throws NoTurnException throws a NoTurnException if the player is trying to draw a card when it is not his turn.
     * @throws NoNameException throws a NoNameException if a player with the given nickname does not exist.
     */
    Integer[] drawCard(String nickname, boolean gold, int onTableOrDeck) throws RemoteException, WrongGamePhaseException, NoTurnException, NoNameException, CardPositionException;
}
