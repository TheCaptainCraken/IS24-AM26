...
public class LittleModel {
     ...
     * game.
     * The hands are represented by a HashMap where the key is the player's nickname
     * and the value is an array of Pairs representing the Kingdom and visibility of
     * the cards in the player's hand.
     *
     * @return A HashMap representing the nicknames of the players and their
